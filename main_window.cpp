...
int MainWindow::get_column(str zueg)
{
    if (zueg == "1A")
    {
        return 1;
...
char MainWindow::get_row(str zueg)
{
    if (zueg == "1A")
    {
        return 'A';
...
MainWindow::MainWindow(bool unmoeglich, QWidget *parent) : QMainWindow(parent),
    ui(new Ui::MainWindow),
    moeglich{unmoeglich},
    compi(moeglich,field)
{
    ui->setupUi(this);
    QObject::connect(ui->A1,&QPushButton::clicked,this,&MainWindow::on_A1_clicked);
    QObject::connect(ui->A2,&QPushButton::clicked,this,&MainWindow::on_A2_clicked);
    QObject::connect(ui->A3,&QPushButton::clicked,this,&MainWindow::on_A3_clicked);
    QObject::connect(ui->B1,&QPushButton::clicked,this,&MainWindow::on_B1_clicked);
    QObject::connect(ui->B2,&QPushButton::clicked,this,&MainWindow::on_B2_clicked);
    QObject::connect(ui->B3,&QPushButton::clicked,this,&MainWindow::on_B3_clicked);
    QObject::connect(ui->C1,&QPushButton::clicked,this,&MainWindow::on_C1_clicked);
    QObject::connect(ui->C2,&QPushButton::clicked,this,&MainWindow::on_C2_clicked);
    QObject::connect(ui->C3,&QPushButton::clicked,this,&MainWindow::on_C3_clicked);
    QObject::connect(ui->play_aigan,&QPushButton::clicked,this,&MainWindow::on_play_aigan_clicked);
...
void MainWindow::setze_Text(const int button, QString text, QCursor curs, bool checkabel)
{
    switch (button)
    {
    case 1:
...
Feld MainWindow::mache_compi_zug(Feld field)
{
...
void MainWindow::on_play_aigan_clicked()
{
    field.clear();
